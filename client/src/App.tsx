...
function Router() {
  return <DashboardLayout><Switch><Route path="/" component={Home} /><Route path="/diario"><OperationalPage mode="diario" /></Route><Route path="/frentes"><OperationalPage mode="frentes" /></Route><Route path="/eventos"><OperationalPage mode="eventos" /></Route><Route path="/timeline"><OperationalPage mode="timeline" /></Route><Route path="/cadastro" component={SetupPage} /><Route path="/404" component={NotFound} /><Route component={NotFound} /></Switch></DashboardLayout>;
}
